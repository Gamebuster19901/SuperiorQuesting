...
public class PacketPageUnhide extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketPageUnhide() {
		super(PacketType.PAGE_UNHIDE);
	}
	
	public PacketPageUnhide(Page p) {
		this();
		id = p.getUUID();
	}
	
	public PacketPageUnhide(Page p, UUID... players) {
		this();
		id = p.getUUID();
