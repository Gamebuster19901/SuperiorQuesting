package com.gamebuster19901.superiorquesting.common.network.packet.player.task.notify;
...
public class PacketTaskUnnotify extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketTaskUnnotify() {
		super(PacketType.TASK_UNNOTIFY);
	}
	
	public PacketTaskUnnotify(Task t) {
		this();
		id = t.getUUID();
	}
	
	public PacketTaskUnnotify(Task t, UUID... players) {
		this();
		id = t.getUUID();
