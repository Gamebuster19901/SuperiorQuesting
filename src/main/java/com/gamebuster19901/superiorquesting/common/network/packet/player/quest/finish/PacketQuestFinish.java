package com.gamebuster19901.superiorquesting.common.network.packet.player.quest.finish;
...
public class PacketQuestFinish extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketQuestFinish() {
		super(PacketType.QUEST_FINISH);
	}
	
	public PacketQuestFinish(Quest q) {
		this();
		id = q.getUUID();
	}
	
	public PacketQuestFinish(Quest q, UUID... players) {
		this();
		id = q.getUUID();
