package com.gamebuster19901.superiorquesting.common.network.packet.player.page.lock;
...
public class PacketPageUnlock extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketPageUnlock(){
		super(PacketType.PAGE_UNLOCK);
	}
	
	public PacketPageUnlock(Page p) {
		this();
		id = p.getUUID();
	}
	
	public PacketPageUnlock(Page p, UUID... players) {
		this();
		id = p.getUUID();
