package com.gamebuster19901.superiorquesting.common.network.packet.player.task.hide;
...
public class PacketTaskUnhide extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketTaskUnhide() {
		super(PacketType.TASK_UNHIDE);
	}
	
	public PacketTaskUnhide(Task t) {
		this();
		id = t.getUUID();
	}
	
	public PacketTaskUnhide(Task t, UUID... players) {
		this();
		id = t.getUUID();
