package com.gamebuster19901.superiorquesting.common.network.packet.player.quest.hide;
...
public class PacketQuestHide extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketQuestHide() {
		super(PacketType.QUEST_HIDE);
	}
	
	public PacketQuestHide(Quest q) {
		this();
		id = q.getUUID();
	}
	
	public PacketQuestHide(Quest q, UUID... players) {
		this();
		id = q.getUUID();
