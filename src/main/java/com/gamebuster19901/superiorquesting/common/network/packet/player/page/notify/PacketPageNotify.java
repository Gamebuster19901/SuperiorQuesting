...
public class PacketPageNotify extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketPageNotify() {
		super(PacketType.PAGE_NOTIFY);
	}
	
	public PacketPageNotify(Page p) {
		this();
		id = p.getUUID();
	}
	
	public PacketPageNotify(Page p, UUID... players) {
		this();
		id = p.getUUID();
