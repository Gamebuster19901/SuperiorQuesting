...
public class PacketRewardCollect extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketRewardCollect() {
		super(PacketType.REWARD_COLLECT);
	}
	
	public PacketRewardCollect(Reward r) {
		this();
		id = r.getUUID();
	}
	
	public PacketRewardCollect(Reward r, UUID... players) {
		this();
		id = r.getUUID();
