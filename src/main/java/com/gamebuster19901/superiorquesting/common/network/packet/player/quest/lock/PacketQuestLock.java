package com.gamebuster19901.superiorquesting.common.network.packet.player.quest.lock;
...
public class PacketQuestLock extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketQuestLock() {
		super(PacketType.QUEST_LOCK);
	}
	
	public PacketQuestLock(Quest q) {
		this();
		id = q.getUUID();
	}
	
	public PacketQuestLock(Quest q, UUID... players) {
		this();
		id = q.getUUID();
