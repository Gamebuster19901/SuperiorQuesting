package com.gamebuster19901.superiorquesting.common.network.packet.player.quest.collection;
...
public class PacketQuestCollect extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketQuestCollect() {
		super(PacketType.QUEST_COLLECT);
	}
	
	public PacketQuestCollect(Quest q) {
		this();
		id = q.getUUID();
		players = new ArrayList<UUID>();
	}
	
	public PacketQuestCollect(Quest q, UUID... players) {
		this();
		id = q.getUUID();
