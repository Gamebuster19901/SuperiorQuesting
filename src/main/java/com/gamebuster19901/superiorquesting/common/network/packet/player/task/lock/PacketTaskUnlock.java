package com.gamebuster19901.superiorquesting.common.network.packet.player.task.lock;
...
public class PacketTaskUnlock extends GenericQuestingPacket{
	...
	public PacketTaskUnlock() {
		super(PacketType.TASK_UNLOCK);
	}
	
	public PacketTaskUnlock(Task t) {
		this();
		id = t.getUUID();
	}

	public PacketTaskUnlock(Task t, UUID... players) {
		this();
		id = t.getUUID();
