package com.gamebuster19901.superiorquesting.common.network.packet.player.page.notify;
...
public class PacketPageUnnotify extends GenericQuestingPacket{
	public UUID id;
	public List<UUID> players = new ArrayList<UUID>();
	
	public PacketPageUnnotify() {
		super(PacketType.PAGE_UNNOTIFY);
	}
	
	public PacketPageUnnotify(Page q) {
		this();
		id = q.getUUID();
	}
	
	public PacketPageUnnotify(Page q, UUID... players) {
		this();
		id = q.getUUID();
